...
public class desktop {
	public static void automation() throws InterruptedException{
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-pat3-no");
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-pat4-no");
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-pat5-yes");
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-pat5-no");
		
		driver.get("http://localhost:4503/content/kadcyla/en_us/hcp/resources/financial-assistance.html");
		remove(driver);
		jse.executeScript("window.scrollBy(0,700)");
		driver.findElement(By.className("gene-component--accordionTabs__item--q1")).click();
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-tab1");
		
		driver.get("http://localhost:4503/content/kadcyla/en_us/hcp/resources/financial-assistance.html");
		remove(driver);
		jse.executeScript("window.scrollBy(0,900)");
		driver.findElement(By.className("gene-component--accordionTabs__item--q2")).click();
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-tab2");
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-6.1-tab3");
...
//		driver.findElement(By.name("practice-name")).sendKeys("Accend group");
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-register");	
		driver.findElement(By.xpath("//form/div[5]/div/div/div")).click();
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-register-classification");
		driver.findElement(By.xpath("//form/div[5]/div[2]/div/div")).click();
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-register-specialty");
		...
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-register-signup");
		
		driver.get("http://localhost:4503/content/kadcyla/en_us/hcp/safety.html");
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-safety");
		driver.get("http://localhost:4503/content/kadcyla/en_us/hcp/sitemap.html");
		remove(driver);
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-sitemap");
		driver.get("http://localhost:4503/content/kadcyla/en_us/hcp/references.html");
		remove(driver);
		fullpage.desktopScreenshot(driver, "kadcyla-hcp-references");
		
		driver.get("http://localhost:4503/content/kadcyla/en_us/hcp.html");
		visiblescreen.desktopScreenshots(driver ,"kadcyla-hcp");
		
		element = driver.findElement(By.linkText("About KADCYLA"));
		action.moveToElement(element).build().perform();		
		visiblescreen.desktopScreenshots(driver ,"kadcyla-hcp-hover-1.0");
		
		element = driver.findElement(By.linkText("Resources"));
		action.moveToElement(element).build().perform();		
		visiblescreen.desktopScreenshots(driver ,"kadcyla-hcp-hover-6.0");
		
		driver.navigate().refresh();
		jse.executeScript("window.scrollTo(0,document.body.scrollHeight)", "");
		driver.findElement(By.linkText("www.fda.gov/medwatch")).click();
		jse.executeScript("window.scrollTo(0,0)", "");
		visiblescreen.desktopScreenshots(driver ,"kadcyla-hcp-link-modal");
